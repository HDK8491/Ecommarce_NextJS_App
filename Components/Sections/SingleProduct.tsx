...
const SingleProduct = (onChange: any, products:any ) => {
  ...
  return (
    <div className="h-screen bg-slate-50  overflow-hidden ">
      <div className="Category py-1 px-60 text-xs font-thin">
        <p>
          Electronics›Mobiles & Accessories›Smartphones & Basic
          Mobiles›Smartphones
        </p>
      </div>
      <div className="product-data flex  p-2 justify-center gap-[2rem] ">
        <div className="img_Category">
          <div className="image-column  w-19">
            {images.map((image, index) => (
              <img
                ...
                src={image.src}
                alt={image.alt}
                className=" border border-gray-600 rounded-xl p-1 mb-2 "
              />
            ))}
          </div>
        </div>
        <div className="main_image">
          <Share />
          <img src="mv.jpg" className="w-50 h-80 object-cover " />
        </div>
